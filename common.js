...
// Jeder Check-in referenziert ein gespeichertes Ereignis (ereignisId) aus
// COL_CHECKIN_EVENTS - Ereignisse werden vorab angelegt und bleiben
// bestehen, bis sie explizit gelöscht werden.
export const COL_CHECKINS = "checkins";
export const COL_CHECKIN_EVENTS = "checkin_events";
...
export const RUNEN = [
  { symbol: "ᚠ", name: "Fehu", bedeutung: "Wohlstand, Vieh, Glück", buchstabe: "F" },
  { symbol: "ᚢ", name: "Uruz", bedeutung: "Kraft, Auerochse, Gesundheit", buchstabe: "U" },
  { symbol: "ᚦ", name: "Thurisaz", bedeutung: "Riese, Konfliktkraft, Durchsetzung", buchstabe: "TH" },
  { symbol: "ᚨ", name: "Ansuz", bedeutung: "Gottheit, Kommunikation, Weisheit", buchstabe: "A" },
  { symbol: "ᚱ", name: "Raidho", bedeutung: "Reise, Wandel, Bewegung", buchstabe: "R" },
  { symbol: "ᚲ", name: "Kenaz", bedeutung: "Fackel, Leidenschaft, Kreativität", buchstabe: "K" },
  { symbol: "ᚷ", name: "Gebo", bedeutung: "Geschenk, Partnerschaft, Austausch", buchstabe: "G" },
  { symbol: "ᚹ", name: "Wunjo", bedeutung: "Freude, Harmonie, Erfolg", buchstabe: "W" },
  { symbol: "ᚺ", name: "Hagalaz", bedeutung: "Hagel, Umbruch, Gleichgewicht", buchstabe: "H" },
  { symbol: "ᚾ", name: "Nauthiz", bedeutung: "Not, Willenskraft, Ausdauer", buchstabe: "N" },
  { symbol: "ᛁ", name: "Isa", bedeutung: "Eis, Stillstand, Klarheit", buchstabe: "I" },
  { symbol: "ᛃ", name: "Jera", bedeutung: "Jahr, Ernte, Kreislauf", buchstabe: "J" },
  { symbol: "ᛇ", name: "Eihwaz", bedeutung: "Eibe, Widerstandskraft, Verbindung", buchstabe: "EI" },
  { symbol: "ᛈ", name: "Perthro", bedeutung: "Würfelbecher, Schicksal, Geheimnis", buchstabe: "P" },
  { symbol: "ᛉ", name: "Algiz", bedeutung: "Schutz, Elch, Lebenskraft", buchstabe: "Z" },
  { symbol: "ᛊ", name: "Sowilo", bedeutung: "Sonne, Sieg, Erfolg", buchstabe: "S" },
  { symbol: "ᛏ", name: "Tiwaz", bedeutung: "Gott Tyr, Gerechtigkeit, Sieg", buchstabe: "T" },
  { symbol: "ᛒ", name: "Berkano", bedeutung: "Birke, Geborgenheit, Erneuerung", buchstabe: "B" },
  { symbol: "ᛖ", name: "Ehwaz", bedeutung: "Pferd, Fortschritt, Vertrauen", buchstabe: "E" },
  { symbol: "ᛗ", name: "Mannaz", bedeutung: "Mensch, Gemeinschaft, Selbsterkenntnis", buchstabe: "M" },
  { symbol: "ᛚ", name: "Laguz", bedeutung: "Wasser, Lebenskraft, Heilung", buchstabe: "L" },
  { symbol: "ᛜ", name: "Ingwaz", bedeutung: "Gott Ing, Fruchtbarkeit, Wachstum", buchstabe: "NG" },
  { symbol: "ᛞ", name: "Dagaz", bedeutung: "Tag, Erwachen, Hoffnung", buchstabe: "D" },
  { symbol: "ᛟ", name: "Othala", bedeutung: "Erbe, Wohlstand, Zugehörigkeit", buchstabe: "O" }
];
